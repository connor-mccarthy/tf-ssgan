...
from ganbert import GAN  # noqa: E402
...
def fit_ganbert(use_saved_weights=False) -> None:
    ...
    generator = make_generator((LATENT_VECTOR_SIZE,), BERT_POOLED_OUTPUT_DIMS)
    discriminator = make_discriminator(
        (BERT_POOLED_OUTPUT_DIMS,), n_classes=AG_NEWS_NUM_LABELED_CLASSES
    )
    ganbert = GAN(
        generator=generator,
